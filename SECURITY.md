...
| 0.0.1   | :white_check_mark: | Except on Rust 1.56.0-1, which do not compile this version due to a regression.<br>See: <https://github.com/rust-lang/rust/issues/89190> |
